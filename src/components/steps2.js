        ...
        <div className="steps2-container2 thq-grid-2">
          <div className="steps2-section-header">
            ...
            <p className="thq-body-large">
              Wish wall is the place where you can leave an anonymous message for our elders, spread positivity and make their day. 
            <h1>Treat People With Kindness &hearts; </h1>
          ...
          <div className="steps2-container3">
                ...
                {props.step1Description ?? (
                  <Fragment>
                    <span className="steps2-text25">
                      Fill out our Google Form to sign up as a volunteer and
                      indicate your availability and interests in helping
                      seniors.
                    </span>
                  </Fragment>
                )}
            ...
            <div className="steps2-container5 thq-card">
              <h2 className="thq-heading-2">
                {props.step2Title ?? (
                  <Fragment>
                    <span className="steps2-text27">Choose Your Program</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step2Description ?? (
                  <Fragment>
                    <span className="steps2-text28">
                      ...
                      Wall,&apos; or &apos;Bado Ka Sikhaya&apos; for mutual
                      learning.
                    </span>
                  </Fragment>
                )}
            ...
            <div className="steps2-container6 thq-card">
              <h2 className="thq-heading-2">
                {props.step3Title ?? (
                  <Fragment>
                    <span className="steps2-text30">Get Matched</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step3Description ?? (
                  <Fragment>
                    <span className="steps2-text26">
                      Our team will match you with a senior based on your
                      preferences and availability, ensuring a meaningful
                      connection.
                    </span>
                  </Fragment>
                )}
                ...
                {props.step4Description ?? (
                  <Fragment>
                    <span className="steps2-text31">
                      Once matched, start engaging with your senior through
                      calls, messages, fulfilling wishes, or participating in
